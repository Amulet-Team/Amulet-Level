...
class AMULET_LEVEL_EXPORT JavaDimension : public Dimension {
private:
...
public:
    ...
    // Thread safe.
    std::shared_ptr<JavaChunkHandle> get_java_chunk_handle(std::int64_t cx, std::int64_t cz);
